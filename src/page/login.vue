        ...
        <ul>
          <li class="account_box">
            ...
            <div class="right_item border-bottom">
              <input v-model="userPhoneNum" type="text" name="account" placeholder="用户名/邮箱/手机号" v-on:focusin="show" @blur="checkEmpty">
            </div>
          </li>
          <li class="password_box">
            <i class="left_item password"></i>
            <div class="right_item ">
              <input v-model="userPassword" type="password" name="password" placeholder="密码/动态密码" @blur="checkEmpty">
          ...
          <li class="yanzhengma_box" v-show="showYanzhengma">
            ...
            <div class="right_item">
              <input v-model="userYanZhengMa" type="text" name="yanzhengma" placeholder="请输入验证码" @blur="checkEmpty">
